...
こちらにWindows環境しかなかったのでわかりませんが、
コマンドプロンプトより、「python ファイル名.py」で実行可能です
...
お題２（q_2.py）IPアドレス判定
付属のaddress.txtはq_2.pyと同じ階層に置いてください。
...
判定ケース1だと正方形を第一象限、第二象限・・・のように分けられるので、第一象限が#なら上のパターンを敷き詰める、.なら・・・とイメージできる。
#.|..
##|..
------
#.|#.
...
処理3.できたこのパターンを返し、今度は同じようにそのパターンを使用して、処理2を行う。
#...|....
##..|....
#.#.|....
####|....
